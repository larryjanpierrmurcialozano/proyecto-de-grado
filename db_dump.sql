...
CREATE TABLE `comunicados_rectoria` (
  ...
  `audiencia` enum('General','Docentes','Coordinación','Administrativo') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'General',
...
CREATE TABLE `plantillas_asistencias` (
  ...
  `id_usuario` int NOT NULL,
  `nombre_plantilla` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-04-10 11:04:32

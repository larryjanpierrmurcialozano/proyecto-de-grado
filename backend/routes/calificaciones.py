...
# salido de la lista, tipo en caso de seleccionar el grado 7, que se genere la carpeta con el nombre /grado_7_calificaciones (calificaciones/grado_7_calificaciones/grupo_A_calificaciones.xlsx), y que al descargarlo se descargue con ese nombre, y al subirlo se suba con ese nombre,
